...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        switch (subCommand) {
            ...
            case 'author': {
                const authorDescription = `Hey there, I'm **Zelly**! My developer/creator is **juziiii**. My goal is to liven up your server by bringing entertainment and good vibes, always ready to brighten your day ${emojis.love}`;
                const discordUserUrl = `https://discord.com/users/910765858178088970`;
                const botAvatarUrl = client.user.displayAvatarURL({ dynamic: true, size: 1024 });
